#!/usr/bin/env python
"""Upload trivia-captain deliverables to the Captain Archibald Drive folder
and write back to the TriviaCaptainQueue row.
...
def _upload_or_replace(
    ...
    """Upload `local_path` to the Captain Archibald Drive folder as
