...
Two spreadsheets feed the trivia-captain-reaction pipeline (shared, read-only,
identical to the trivia-reaction / trivia-captain sources):
  ...
  - LocalizedTextConfig (1y-REopUmAtoirAp-8rOMNz7LlqLe2mjVAlkdhmGKgtY)
      Uid -> 13-locale string dictionary. trivia-captain-reaction is EN-only
      for ship-1 (col B = EN). Lookup is exact-match on col A.
...
# These are the columns currently used by the reaction pipelines. Pinned to the
