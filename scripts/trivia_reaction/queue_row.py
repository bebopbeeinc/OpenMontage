"""TriviaReactionQueue schema, reader, and writer (workflow-state SoT).
...
The TriviaReactionQueue sheet is THIS pipeline's source of truth for workflow
...
# Pinned IDs.
QUEUE_SHEET = "1nFsNwGZXyBX91Vg2-5dftvnoMXSb2iHxfrPHGrItbW8"
QUEUE_TAB = "Queue"
QUEUE_HEADER_ROW = 2
