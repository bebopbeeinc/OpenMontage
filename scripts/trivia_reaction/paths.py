"""Path helpers for the trivia-reaction pipeline.

All trivia-reaction project workspaces live under
`projects/trivia-reaction/<slug>/`. The pipeline-scoped subdirectory
