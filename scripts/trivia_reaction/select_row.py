#!/usr/bin/env python
"""Read one daily-trivia Day and write a brief artifact for the trivia-reaction pipeline.
...
What it does:
    ...
    4. Write projects/trivia-reaction/<slug>/artifacts/brief.json (schema-flexible; see metadata.trivia_reaction).
    5. Upsert the TriviaReactionQueue row: Day, Slug, Status=Draft, Question, Correct Answer.
...
Usage:
    python scripts/trivia_reaction/select_row.py --day 2
    python scripts/trivia_reaction/select_row.py --day 2 --slug guinea-pigs-switzerland
    python scripts/trivia_reaction/select_row.py --day 2 --dry-run
"""
    ...
    brief = {
        ...
        "metadata": {
            ...
            "trivia_reaction": {
                ...
                "character_ref": "ellie.travelcrush",
